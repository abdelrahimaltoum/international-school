    ...
    return(
        <div className="related-pages">
            ...
            <div className="related-pages-row">
             <Link to="/our-school">  <RelatedPagesItem
                ...
                info=" We are very excited and pleased to introduce to you GEMS International School Cairo."/></Link> 
              <Link to="vision-and-mission">   <RelatedPagesItem
                ...
                info="We empower the genius in every child and enable them to make an impact."/></Link>
              <Link to="/our-core-values">  <RelatedPagesItem
                ...
                info="At GISC we provide each student with a holistic, inquiry-based, and engaging curriculum. "/></Link>
              <Link to="/our-team">   <RelatedPagesItem
                ...
                info="We are a team of dedicated teachers driven by passion and guided by years of experience in educating young talents."/></Link>
            </div>
            <div className="related-pages-row">
         <Link to="/campus-and-location">  <RelatedPagesItem
                ...
                info="We believe in the importance of well-being and striking the right balance between academic pursuits and leisure. "/></Link> 
             <Link to="/health-and-safety">   <RelatedPagesItem
                ...
                info="GEMS Education has 60 years' experience of delivering the highest standards in Health and Safety across our schools."/></Link> 
               <Link to="/Vacancies">  <RelatedPagesItem
                ...
                name="Vacancies"
                info="We welcome employment inquiries from experienced, qualified teachers and those seeking administrative positions. "/></Link>
           <Link to="/The-GEMS-Difference">     <RelatedPagesItem
                ...
                info="From humble beginnings, GEMS Education has grown to become one of the world's largest private education providers"/></Link> 
            </div>
