...
function WhyGISCPage(){
    ...
    return(
        <div className="Why-GISC-page">
            ...
            <Link to="/Accreditations">   <WhyGISCPageItem
               ...
               /> </Link>
            <Link to="/Educational-Experts" >   <WhyGISCPageItem
               ...
               /></Link> 
            <Link to="/Technology-for-the-Future">    <WhyGISCPageItem
               ...
               /></Link> 
           <Link to="/a-value-driven-community">     <WhyGISCPageItem
